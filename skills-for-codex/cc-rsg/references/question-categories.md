...
#### How to resolve
- Consult the external system's official documentation (use official-doc lookup).
...
- Interactive custom-category addition through a user-facing prompt in Codex
...
| external_integration | Prefer external-doc lookup (official-doc lookup) |
