...
|---|---|---|
| 🟢 **VERIFIED** | Confirmed the real code by reading it with the available Codex file tools | The file appears in the read history |
...
|---|---|---|
| `app/models/` | ActiveRecord models | `file-listing 'app/models/**/*.rb'` |
| `app/controllers/` | Controllers | `file-listing 'app/controllers/**/*.rb'` |
| `app/views/` | Templates | `file-listing 'app/views/**/*'` |
| `app/helpers/` | View helpers | `file-listing 'app/helpers/**/*.rb'` |
| `app/jobs/` | Background jobs | `file-listing 'app/jobs/**/*.rb'` |
| `app/mailers/` | Mailers | `file-listing 'app/mailers/**/*.rb'` |
| `lib/` | Project-specific library code | `file-listing 'lib/**/*.rb'` |
| `config/` | Configuration | `file-listing 'config/**/*.{rb,yml}'` |
| `db/migrate/` | Migrations | `file-listing 'db/migrate/*.rb'` |
| `plugins/` or `engines/` | Plugins / engines | `file-listing 'plugins/**/*' or 'engines/**/*'` |
...
Next.js App Router:
```
file-listing 'src/app/api/**/route.ts'
```
